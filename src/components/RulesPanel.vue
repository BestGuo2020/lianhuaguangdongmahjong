...
const rules = computed(() => {
  if (props.variant === 'lotus-legacy') {
    return [
      ...
      ['面子规则', '乱风顺（任意 3 种风）、三元顺（中发白）可成面子；精牌可补缺张、做将，白板只能替代本局精牌或白板本身；二者也可按自身牌面作为普通牌参与吃碰杠。'],
  ...
  return [
    ...
    ['胡后买马', '胡牌者从牌墙尾摸 8 张马牌，按胡牌者相对庄家的座位判定中马：庄家 1/5/9 与东、下家 2/6 与红中南、对家 3/7 与发西、上家 4/8 与白北；每中一张按一份底分加算。'],
  ]
})
