...
// 不使用「仅此而已」等已被局末库用滥的收尾套语，句首语气词按性格打散（见 `bloodFlowWinLines.test.ts`）。
...
/**
 * 档位优先级：一炮多响 > 大牌（主番 ≥8）> 连胡（第 3 胡起且与上一胡同源）> 胡法基础档。
