...
export const BASELINE_AI = Object.freeze({ ...BLOOD_FLOW_AI, chainForecast: 'legacy' as const, opportunityCalibration: undefined, routeOpportunityGuard: false, claimMeldProjection: false, claimReadyNetGuard: false })
